          ...
          <div className="center-container">
            <NESContainerW title="" className="center style scrollable" scrollable={true}>
              ...
              <p>
                ...
                Everyone else is{" "}
                <span style={{ fontWeight: "bold", color: "green" }}>Villager</span>.
              </p>
              <p>The villagers all see the clue word, the wolf does not.</p>
              <p>
                As <span style={{ fontWeight: "bold", color: "green" }}>villagers</span>
